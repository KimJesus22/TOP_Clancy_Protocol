...
import {
  buildEvidenceDetailStructuredData,
  jsonLdScriptProps,
...
export default async function EvidenceDetailPage({
  ...
  const structuredData = buildEvidenceDetailStructuredData(evidence);

  return (
    <>
      {structuredData.map((schema, index) => (
        <script
          key={`expediente-structured-data-${index}`}
          id={`structured-data-expediente-${index}`}
