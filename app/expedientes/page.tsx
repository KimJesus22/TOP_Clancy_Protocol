...
import {
  buildEvidenceIndexStructuredData,
  jsonLdScriptProps,
...
export default function ExpedientesPage() {
  ...
  const structuredData = buildEvidenceIndexStructuredData(evidenceRecords);

  return (
    <>
      {structuredData.map((schema, index) => (
        <script
          key={`expedientes-structured-data-${index}`}
          id={`structured-data-expedientes-${index}`}
